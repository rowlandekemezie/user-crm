(function() {
  ...
  apiRouter.post('/sample', function() {
    ...
    apiRouter.post('/authenticate', function(req, res) {
      ...
      //  since mongoose is not returning it by default
      User.findOne({
    ...
    apiRouter.use(function(req, res, next) {
      ...
      if (token) {
        ...
        // (access forbidden) and an error message
    ...
    apiRouter.route('/users')
      ...
      .post(function(req, res) {
        ...
        user.username = req.body.username; // set the users username
